...
def get_data_for_digit(source,digit):
    ...
    for i in range(0+digit*NUM_EXAMPLES_PER_USER, NUM_EXAMPLES_PER_USER*(1+digit), 1):
...
for round_num in range(100):
    ...
    channel = rayleigh.Rayleigh_2(7850,rayleigh.threshold100,1,10)
    for i in range(10):
        for j in range(784):
            for k in range(10):
                num = (j-1)*10+k-1
